...
class App extends Component {
    ...
    fetchWeather = async ( event ) => {
        ...
        try {
            ...
            var url = 'https://geo.api.gouv.fr/communes?nom='+this.state.city;
            ...
            if ( request.get(url) ) {
                ...
                let updatedWeatherWithImage = await this.fetchPicture( request.get(url) )
    ...
    displayWeatherInfo = () => {
        ...
        */
        ...
        if ( weather ) {
            ...
            const locationName = weather.nom
